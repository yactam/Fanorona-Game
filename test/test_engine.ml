      ...
      ("is_valid_move_position",
        [
          test_case "successful linear move" `Quick (fun () -> 
            ...
            (is_valid_move_position initial_state_5x9 {position = (Pos.(h 3), Pos.(v 4)); direction = N} W));
          test_case "successful diagonal move" `Quick (fun () -> 
            Alcotest.(check bool) "same result" true 
            (is_valid_move_position initial_state_5x9 {position = (Pos.(h 3), Pos.(v 3)); direction = NE} W));
          test_case "incorrect pawn player move" `Quick (fun () -> 
            Alcotest.(check bool) "same result" false
            (is_valid_move_position initial_state_5x9 {position = (Pos.(h 1), Pos.(v 4)); direction = S} W));
          test_case "move empty cell" `Quick (fun () -> 
            Alcotest.(check bool) "same result" false
            (is_valid_move_position initial_state_5x9 {position = (Pos.(h 2), Pos.(v 4)); direction = N} W));
          test_case "move into pawn" `Quick (fun () -> 
            Alcotest.(check bool) "same result" false
            (is_valid_move_position initial_state_5x9 {position = (Pos.(h 3), Pos.(v 4)); direction = S} W));
          test_case "diagonal move on non diagonal pos" `Quick (fun () -> 
            Alcotest.(check bool) "same result" false
            (is_valid_move_position board_1 {position = (Pos.(h 1), Pos.(v 0)); direction = SE} B));
        ]);
      ("is_capture_move",
        [
          test_case "(3, 4) to (2,4) starter inward move" `Quick (fun () -> 
            Alcotest.(check bool) "same result" true 
            (is_capture_move initial_state_5x9 {position = (Pos.(h 3), Pos.(v 4)); direction = N} W));
          test_case "(3,3) to (2,4) starter inward move" `Quick (fun () -> 
            Alcotest.(check bool) "same result" true 
            (is_capture_move initial_state_5x9 {position = (Pos.(h 3), Pos.(v 3)); direction = NE} W));
          test_case "outward capture move" `Quick (fun () -> 
            Alcotest.(check bool) "same result" true 
            (is_capture_move board_1 {position = (Pos.(h 1), Pos.(v 1)); direction = E} W));
          test_case "non capture move" `Quick (fun () -> 
              Alcotest.(check bool) "same result" false 
            (is_capture_move board_1 {position = (Pos.(h 3), Pos.(v 0)); direction = E} W));
          test_case "invalid move into pawn capture move" `Quick (fun () -> 
            Alcotest.(check bool) "same result" false
            (is_capture_move board_3 {position = (Pos.(h 2), Pos.(v 2)); direction = S} B));
        ]);
      ("get_all_moves",
        [
          ...
          test_case "one valid capture move, one invalid escape move" `Quick (fun () -> 
            Alcotest.(check (list move)) "same result" 
          ...
          test_case "no capture moves" `Quick (fun () -> 
            Alcotest.(check (list move)) "same result" 
            [
             {position = (Pos.(h 0), Pos.(v 4)); direction = N}; {position = (Pos.(h 0), Pos.(v 4)); direction = E}; {position = (Pos.(h 0), Pos.(v 4)); direction = S};
             {position = (Pos.(h 2), Pos.(v 0)); direction = W};{position = (Pos.(h 2), Pos.(v 0)); direction = SW};{position = (Pos.(h 2), Pos.(v 0)); direction = S};{position = (Pos.(h 2), Pos.(v 0)); direction = SE};{position = (Pos.(h 2), Pos.(v 0)); direction = E};
             {position = (Pos.(h 4), Pos.(v 3)); direction = E};{position = (Pos.(h 4), Pos.(v 3)); direction = N};{position = (Pos.(h 4), Pos.(v 3)); direction = W};
             {position = (Pos.(h 3), Pos.(v 6)); direction = N};{position = (Pos.(h 3), Pos.(v 6)); direction = W};
             {position = (Pos.(h 4), Pos.(v 6)); direction = NW};{position = (Pos.(h 3), Pos.(v 6)); direction = W};
             {position = (Pos.(h 2), Pos.(v 7)); direction = N};{position = (Pos.(h 2), Pos.(v 7)); direction = W};
             {position = (Pos.(h 3), Pos.(v 7)); direction = NW};{position = (Pos.(h 3), Pos.(v 7)); direction = NE};
